...
#define COIL_OFF 0
#define COIL_ON  1
#define COIL_ON_TIME 50 //the amount of time a coil is allowed to be continuously on for
#define COIL_COOLDOWN_TIME 50 //the amount of time a coil must be off before firing again

#define FLASHER_ON_TIME 10
#define FLASHER_COOLDOWN_TIME 20

#define BUTTON_COOLDOWN_TIME 50 //the amount of time a button must wait before acting again
